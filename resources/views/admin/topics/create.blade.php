    ...
    <div class="mx-2">
      ...
      <form action="{{route('topics.store')}}" method="POST" class="px-md-5" enctype="multipart/form-data">
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
            <input type="text" placeholder="add title. Design Patterns" class="form-control py-2" name="topictitle" value="{{old('topictitle')}}" />
            @error('topictitle')
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
            <select name="category" id="" class="form-control py-1" value="{{old('category')}}">
