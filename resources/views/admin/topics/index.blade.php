                ...
                <table class="table table-hover display" id="_table">
                    ...
                    <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a class="text-decoration-none text-dark" href="{{ route('topics.show', $topic['id'])}}">{{ $topic['topictitle']}}</a>
                            </td>

                            <td>@if($topic->category) 
                            ...
                            <td class="text-center">
                              ...
                              <a class="text-decoration-none text-dark" href="#"><img src="assests/images/trash-can-svgrepo-com.svg"></a> 
                              @csrf   
                              @method('DELETE') 
                              </form>
                            </td> 
