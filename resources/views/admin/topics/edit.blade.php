    ...
    <div class="mx-2">  
        ...
        <form action="{{ route('topics.update', $topic->id) }}" method="POST" enctype="multipart/form-data">  
            ...
            <div class="form-group mb-3 row">  
                ...
                <div class="col-md-10">  
                    <input type="checkbox" name="trending" id="trending" class="form-check-input" style="padding: 0.7rem;"  
                        @checked(old('trending', $topic->trending)) />  
                </div>  
            </div>
            ...
            <div class="form-group mb-3 row">  
                ...
                <div class="col-md-10">  
                    <input type="checkbox" name="published" id="published" class="form-check-input" style="padding: 0.7rem;"  
                        @checked(old('published', $topic->published)) />  
                </div>  
            </div>
            ...
            <div class="form-group mb-3 row">  
                ...
                <div class="col-md-10">  
                    ...
                    @if($topic->image)  
                        <img src="{{ asset('adminassets/images/topics/' . $topic->image) }}" alt="{{ $topic->topictitle }}" style="width: 10rem; margin-bottom: 10px;">  
                    @endif   
                    @error('image')  
                        <div class="alert alert-warning">{{ $message }}</div>  
                    @enderror  
